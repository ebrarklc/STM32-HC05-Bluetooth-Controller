...
int main(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, LED0_Pin|LED1_Pin|LED2_Pin|LED3_Pin|LED4_Pin|LED5_Pin|LED6_Pin|LED7_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOA, BUZZER_Pin, GPIO_PIN_RESET);

  // Bluetooth'a hoş geldin mesajı gönder
  char welcome_msg[] = "STM32 Hazir. Komutlar: LED_AC, LED_KAPAT, BUZZER_AC, BUZZER_KAPAT\r\n";
  ...
  while (1)
  {
      ...
      if (rx_complete)
      {
          ...
          if (strcmp((char*)rx_buffer, "LED_AC") == 0)
          {
              ...
              HAL_GPIO_WritePin(GPIOE, LED0_Pin|LED1_Pin|LED2_Pin|LED3_Pin|LED4_Pin|LED5_Pin|LED6_Pin|LED7_Pin, GPIO_PIN_SET);
